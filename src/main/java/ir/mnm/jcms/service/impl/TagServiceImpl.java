...
public class TagServiceImpl extends AbstractServiceImpl<Tag> implements TagService {
	...
	/**
	 * @see TagService#getByName(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see AbstractServiceImpl#getAllTransactionally()
	 */
	@Override
	@Transactional
	...
	/**
	 * @see TagService#getAutocompleteJson()
	 */
	@Override
	...
	/**
	 * @see TagService#getTagsFromString(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see TagService#getTagString(java.util.Set)
	 */
	@Override
