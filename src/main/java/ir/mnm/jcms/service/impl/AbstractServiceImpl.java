...
import ir.mnm.jcms.service.AbstractService;
...
public abstract class AbstractServiceImpl<T extends Serializable>
	...
	/**
	 * @see AbstractService#add(java.io.Serializable)
	 */
	@Override
	...
	/**
	 * @see AbstractService#addTransactionally(java.io.Serializable)
	 */
	@Override
	@Transactional
	...
	/**
	 * @see AbstractService#get(java.lang.Long)
	 */
	@Override
	...
	/**
	 * @see AbstractService#getTransactionally(java.lang.Long)
	 */
	@Override
	@Transactional
	...
	/**
	 * @see AbstractService#update(java.io.Serializable)
	 */
	@Override
	...
	/**
	 * @see AbstractService#updateTransactionally(java.io.Serializable)
	 */
	@Override
	@Transactional
	...
	/**
	 * @see AbstractService#deleteTransactionally(java.io.Serializable)
	 */
	@Override
	@Transactional
	...
	/**
	 * @see AbstractService#deleteByIdTransactionally(java.lang.Long)
	 */
	@Override
	@Transactional
	...
	/**
	 * @see AbstractService#getAllTransactionally()
	 */
	@Override
	@Transactional
