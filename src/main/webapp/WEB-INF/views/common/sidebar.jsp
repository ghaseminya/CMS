...
<c:url value="/categ/add" var="addCategoryUrl" />
<sec:authorize access="hasRole('ROLE_AUTHOR')">
	<h4><a href="${addArticleUrl}"><spring:message code="home.addArticleUrl" /></a></h4>
	<h4><a href="${addCategoryUrl}"><spring:message code="home.addCategoryUrl" /></a></h4>
	<hr>
</sec:authorize>
...
<div class="sidebar-module">
	...
	<p><spring:message code="sidebar.about.desc" /></p>
</div>
<hr>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<ol class="list-unstyled">
			<li><a href="https://github.com/ghaseminya/CMS">Project on GitHub</a></li>
